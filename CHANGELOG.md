...
- Removed the redundant five-second wall-clock VideoToolbox session rebuild. VideoToolbox's configured frame-count interval supplies routine IDRs; the expensive restart is now reserved for an explicit join/recovery request. Added a one-second VideoToolbox data-rate ceiling at 125% of the selected average bitrate to smooth fullscreen/high-motion bursts without introducing a video queue.
